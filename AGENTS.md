...
- `npm run lint` executes `next lint`; keep this clean before opening a PR.
- `npm run deploy` builds, exports to `out/`, and force-pushes `gh-pages`. Use only after validating the export locally.
